...
const slides = [
	{
		image:
			"https://www.lysol.com/content/dam/commerce/lysol-us/us/en/de71406d3fc6d31dd1c82656b4774bd6c2d25716/_jcr_content/renditions/original",
...
export default function Slider() {
	...
	return (
		<div className="relative w-full h-[540px] md:h-[600px] flex items-center justify-center bg-muted overflow-hidden mt-6">
			...
			{/* Overlay */}
			<div
				className={`absolute inset-0 bg-black/10 z-10 transition-opacity duration-300 ${fade === "in" ? "opacity-100" : "opacity-0"}`}
			/>
